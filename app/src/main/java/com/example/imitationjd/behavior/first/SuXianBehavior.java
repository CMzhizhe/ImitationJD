...
public class SuXianBehavior extends CoordinatorLayout.Behavior<LinearLayout> {

    public SuXianBehavior() {
    }

    public SuXianBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
