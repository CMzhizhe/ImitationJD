 ...
 **/
public class MyThiredLinLerLayout extends LinearLayout implements NestedScrollingParent3{
    private String TAG = MyThiredLinLerLayout.class.getSimpleName();
    ...
    public MyThiredLinLerLayout(Context context) {
        super(context);
        this.mContext = context;
    }

    public MyThiredLinLerLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public MyThiredLinLerLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
